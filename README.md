...
|---------|-------------|------|------|----------|
| `bureaucrats` | He & Wang (2017) bureaucrat quality | 2809 | 18 | |
| `childpen` | Cortés & Pan (2023) child penalty | 54365 | 12 | |
| `cigs` | Abadie, Diamond, & Hainmueller (2010) cigarette sales | 1209 | 7 | |
...
| `tenncare` | Garthwaite, Gross, & Notowidigdo (2014) TennCare disenrollment | 136 | 29 | `micro` |
| `thirdkid` | Angrist & Evans (1998) family size & labor supply | 254652 | 34 | |
| `unions` | Vella & Verbeek (1998) union wages | 4360 | 36 | |
